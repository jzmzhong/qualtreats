...
xab_question_text = "Listen carefully to all speech recordings below in full. Then rank the candidate speech recordings based on their <i><u>similarity</u></i> to the reference speech recording in terms of <i><u>accent</u></i>. Please disregard the mismatch in voice, gender, and audio quality.<br/ >Here is the reference speech recording:"
xab_question_text_2 = "<br/ >Here are the four candidate speech recordings to be ranked."
